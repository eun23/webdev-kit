...
public class BasicController {
  ...
  // Request Body x / Respose Body o / HTML form o
  @GetMapping("")
  ...
  // Request Body o / Respose Body o / HTML form o
  @PostMapping("")
  ...
  //*            - 만약 전송한 데이터랑 동일한 테이터가 있다면 수정
  //*            - 만약 전송한 데이터가 존재하지 않는 데이터면 생성
  //*            - 동일한 데이터를 여러번 전송하더라도 한 번만 적용
  // Request Body o / Respose Body x / HTML form x
  @PutMapping("")
  ...
  // Request Body o / Respose Body o/ HTML form x
  @PatchMapping("")
  ...
  // Request Body x / Respose Body x / HTML form x
  @DeleteMapping("")
