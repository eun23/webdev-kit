...
public class C_DataType {
	public static void main(String[] args) {
		...
		// -128 ~ 127
		byte byte1 = 100;
//		byte byte2 = 128; - Error: 리터럴 데이터 타입(int)과 맞지 않음

		// short: 2byte(16bit)의 크기를 가지는 정수형 데이터 타입
		// -32,768 ~ 32,767
		short short1 = 128;
//		short short2 = 40000; - Error: 리터럴 데이터 타입(int)과 맞지 않음

		// int: 4byte(32bit)의 크기를 가지는 정수형 데이터 타입
		// -2,147,483,648 ~ 2,147,483,647
		int int1 = 40000;
//		int int2 = 2200000000; - Error: 리터럴 값이 표현할 수 있는 범위 = int 범위
//		int int2 = 2_200_000_000L; - Error: Long 타입을 int 타입으로 표현할 수 x
		...
		// flaot : 4byte(32bit)의 크기를 가지는 실수형 데이터 타입
		// 소수점 6-7자리에서 오차가 발생
//		float float1 = 0.123456789; - Error: 리터럴 데이터 타입(double)과 맞지 않음
		...
		// 논리형 데이터 타입: 참곽 거짓 값을 가지는 데이터 타입

		// boolean: 1byet(8bit)의 크기를 가지는 논리형 데이터 타입
		// true, false
...
//		number1 = number2; - Error: long을 int에 담을 수 x
		number1 = (int) number2; // 강제 형변환

		byte number3 = (byte) number2;
		System.out.println(number3); // 44
...
//		string3[0] = "d";
		...
		// String 클래스의 주요 기능
		String statement = "  My Name Is Eun  ";
		...
		System.out.println(statement.equals("My Name Is Eun")); // false
		System.out.println(statement.compareTo("  Ay Name Is Eun  ")); // 12
		...
		System.out.println(statement.replace("Eun", "Siveeer"));
