...
interface AreaCalculation {
	// 변수는 반드시 public static final이기 때문에 생략을 해도 됨
	double PI = 3.14;
...
interface Caculation extends AreaCalculation, NormalCalculation {
	
}

// 인터페이스는 implements 키워드를 이용하여 클래스에서 구현할 수 있음
// 인터페이스는 다중 구현이 가능함
class Calculator implements Caculation // AreaCalculation, NormalCalculation 
{
